...
### env for AHA tools
setenv PATH /usr/bin:/cad/aha/brew/bin:/cad/aha/bin:/cad/tabby/bin:$PATH  #setenv PATH /usr/bin:/cad/aha/brew/bin:/cad/aha/bin:/cad/aha/verific/yosys:$PATH
source /cad/aha/venv/bin/activate.csh
setenv LD_LIBRARY_PATH /cad/aha/venv/lib:/cad/aha/venv/coreir/lib:$LD_LIBRARY_PATH

setenv YOSYSHQ_LICENSE /cad/tabby/etc/tabbycad.lic  #setenv VERIFIC_LICENSE_FILE /cad/aha/verific_200817.license
